...
import { CustomError, InvalidEmail, InvalidName, InvalidPassword, InvalidUser, Unauthorized, UserNotFound } from "../error/customError";
import {
  UserInputDTO,
  user,
  EditUserInputDTO,
...
export class UserBusiness {
  public createUser = async (input: UserInputDTO): Promise<string> => {
    try {
      ...
      if (role.toLocaleLowerCase() !== UserRole.ADMIN && role.toLocaleLowerCase() !== UserRole.NORMAL) {
